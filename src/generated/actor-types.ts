...
import { ServerContext } from 'src/server/index';
...
export type ActorResolvers<ContextType = ServerContext, ParentType extends ResolversParentTypes['Actor'] = ResolversParentTypes['Actor']> = ResolversObject<{
